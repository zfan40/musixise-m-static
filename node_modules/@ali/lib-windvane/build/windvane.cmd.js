...
if (window.KISSY) {KISSY.add('mtb/lib-windvane/2.1.6/windvane.cmd',function() {return window.lib.windvane;},{requries:[]});} else if ('undefined' !== typeof define) {define('mtb/lib-windvane/2.1.6/windvane.cmd', [], function(require){return window.lib.windvane;});}