//musixiser HTTP request wrapper based on axios
...
// axios.get('https://api.github.com/users/xxx');
    	...
    	var instanceConfig = Object.assign({},defaultConfig,config);//config priority higher,will modify first obj,so we put empty obj
        instanceConfig = {url:'http://api.github.com/user/xxx'}
        instance = axios.get(instanceConfig);
