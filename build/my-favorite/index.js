...
/***/ function(module, exports, __webpack_require__) {
	...
	var musixiserListTpl = __webpack_require__(30);
	var workListTpl = __webpack_require__(33);
	var MockData1 = __webpack_require__(34);
	var MockData2 = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = { escape: __webpack_require__(31) };module.exports = function (data) {
	...
	'" data-id="' +
	__e(l.userId) +
	'"></div><div class="info"><span data-id="' +
	__e(l.userId) +
	'">' +
	__e(l.name) +
	'</span><span data-id="' +
...
/***/ function(module, exports) {
	...
	module.exports = {
	    musixisers:[
	      {name:'ono',userId:'5',userAvatar:'./assets/1.jpg',followerNum:'1314',online:true,},
	      {name:'小野妹子',userId:'24',userAvatar:'./assets/2.jpg',followerNum:'10000',online:false},
	      {name:'拉拉',userId:'1',userAvatar:'./assets/3.jpg',followerNum:'1',online:true},
	      {name:'prody',userId:'555',userAvatar:'./assets/4.jpg',followerNum:'114',online:true},
	      {name:'martin',userId:'2',userAvatar:'./assets/1.jpg',followerNum:'10010',online:false},
	      {name:'马克',userId:'123',userAvatar:'./assets/2.jpg',followerNum:'1024',online:true},
	    ]
	  }
...
/***/ function(module, exports) {
	...
	module.exports = {
	    works: [
	      {name:'半岛铁盒',author:'jay',workId:'5',description:'哪里有卖',createTime:'1314',likes:'1002',mp3:''},
	      {name:'她的睫毛',author:'f',workId:'24',description:'睫毛弯弯，眼睛眨呀眨呀眨',createTime:'10000',likes:'10',mp3:''},
	      {name:'最后的战役',author:'princess',workId:'1',description:'我留着陪你，强忍着泪滴',createTime:'100',likes:'924',mp3:''}  	
	    ]
	  }
