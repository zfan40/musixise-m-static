...
/***/ function(module, exports, __webpack_require__) {
	...
	__p += '</div><div class="section-spliter"></div><div class="tab-container"><div class="active tab" id="work-tab">作品</div><div class="tab" id="live-tab">直播</div></div>\n';
	return __p
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	'"><img data-id="' +
	__e(l.id) +
	'" class="work-cover" src="' +
	__e(l.cover?l.cover:l.owner.smallAvatar) +
	'"><div data-id="' +
	__e(l.id) +
	'" class="work-body"><span data-id="' +
	__e(l.id) +
	'" class="work-body-title">' +
	__e(l.title) +
	'</span><span data-id="' +
	__e(l.id) +
	'" class="work-body-desc"><p>' +
	__e(l.content) +
	'</p></span></div></div></li>';
	 } ;
	__p += '</ul>';
