...
/***/ function(module, exports, __webpack_require__) {
	...
	var Musixise = __webpack_require__(4);
	
	var StageListTpl = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = { escape: __webpack_require__(6) };module.exports = function (data) {
	...
	__p += ' ';
	 var l = data.list[i]; ;
	__p += ' <div class="musixiser" id="id' +
	__e(l.name) +
	'" data-name="' +
	__e(l.name) +
	'"><div class="l-avatar"><img src="' +
	__e(l.userAvatar) +
	'" data-name="' +
	__e(l.name) +
	'"></div><div class="info"><div class="section-one"><img class="s-avatar" src="' +
	__e(l.userAvatar) +
	'"></div><div class="section-two"><p class="name">' +
	__e(l.name) +
	'</p></div><p class="listener-total"><span>' +
	__e(l.audienceNum) +
	'</span>在听</p></div> ';
	 if(l.stageTitle) { ;
	__p += ' <p class="caption">' +
