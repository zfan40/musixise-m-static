...
/***/ function(module, exports, __webpack_require__) {
	...
	var workUpdateTpl = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = { escape: __webpack_require__(33) };module.exports = function (data) {
	var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
	function print() { __p += __j.call(arguments, '') }
	
	 if(data) { ;
	__p += '<h2>作品</h2><ul><li><div class="info" data-id="' +
	__e(data.id) +
	'"><span>作品名</span><input id="work-title" placeholder="' +
	__e(data.title) +
	'"><span>作品介绍</span><input id="work-desc" placeholder="' +
	__e(data.content) +
	'"><span>作品封面</span><img src="' +
	__e(data.cover) +
	'"><button id="uploadBtn"></button></div></li></ul>';
	 } ;
	__p += '\n';
	return __p
	};
